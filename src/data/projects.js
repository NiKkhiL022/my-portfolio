...
export const projectsData = [
  ...
  },
  {
    ...
    description: [
      ...
      "Using a static site generator (Eleventy) ensured maximum performance and SEO, while HTML, tailwind-css, and JavaScript were used to create a responsive and engaging user experience that aligns with Mivi's modern brand identity.",
    ],
    imageUrl: banner,
    banner: banner,
    tags: ["Eleventy (11ty)", "HTML5", "tailwind-css3", "JavaScript"],
  ...
  },
  {
    ...
    description: [
      ...
      "My responsibilities included updating product cards with tailwind-css animations, implementing new UI/UX designs across the website, and ensuring all product SKUs were current and accurately displayed.",
    ],
    imageUrl: vlBanner,
    banner: vlBanner,
    tags: ["HTML5", "tailwind-css3", "JavaScript", "tailwind-css Animations"],
    ...
    details: {
      ...
      responsibilities: [
        ...
        "Enhanced the website's aesthetic with modern, performant tailwind-css animations.",
      ],
      images: [vl1, vl2, vl3],
      blocks: [
        {
        ...
        },
        {
          ...
          body: "A core part of the project was to make the online shopping experience more dynamic. I implemented new layouts for product category pages and added subtle tailwind-css animations to product cards to make browsing more engaging and interactive.",
        },
        {
          type: "image",
          src: vl2,
  ...
  },
  {
    ...
    description: [
      ...
      "This work required overcoming the significant technical limitations of email clients by using table-based layouts, inline tailwind-css, and a limited set of HTML tags to ensure consistent rendering across platforms like Gmail, Outlook, and Apple Mail.",
    ],
    imageUrl: emailerBanner,
    banner: emailerBanner,
    tags: ["HTML Tables", "Inline tailwind-css", "Responsive Email Design"],
    link: "/projects/html-email-templates",

    details: {
      about: [
        "Coding for email is a different world from modern web development. Unlike browsers that adhere to web standards, email clients like Outlook have notoriously poor support for modern tailwind-css and HTML. This creates a unique challenge: how to build a beautiful, responsive design using techniques that are decades old.",
      ...
      responsibilities: [
        ...
        "Wrote and inlined tailwind-css for maximum compatibility across dozens of email clients.",
...

  {
    ...
    tags: ["HTML5", "tailwind-css3", "Svelte"],
